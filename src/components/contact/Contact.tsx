...
import { ArrowUpRight, Briefcase, Code2, Mail, MessageCircle } from "lucide-react";
      ...
      <div className="container-px relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 lg:gap-8">
          <div className="lg:col-span-6">
            <Reveal delay={0.1}>
              <p className="text-[var(--muted)] leading-relaxed max-w-md mb-10">
                Available for freelance projects and collaborations. Reach out on any of the
                channels below — I usually reply within a day.
              </p>
            </Reveal>
            ...
            <Reveal delay={0.15}>
              <MagneticButton
                as="a"
                href="mailto:harshagunathilaka5@gmail.com"
                className="inline-flex items-center gap-2 rounded-full bg-[var(--fg)] text-[var(--bg)] px-8 py-4 text-sm font-semibold tracking-wide hover:bg-[var(--accent)] transition-colors duration-300"
                cursorLabel="EMAIL"
              >
